  ...
  const mockBookings = [
    ...
    },
    {
      ...
      trip: { 
        ...
        destination: "Tokyo", 
        image: "https://images.unsplash.com/photo-1540959375944-7049f642e9ba?auto=format&fit=crop&w=800&q=80"
      },
    ...
    },
    {
      ...
      trip: { 
        ...
        destination: "Rome", 
        image: "https://images.unsplash.com/photo-1552832860-cfde47f1835d?auto=format&fit=crop&w=800&q=80"
      },
    ...
    },
    {
      ...
      trip: { 
        ...
        image: "https://images.unsplash.com/photo-1562883676-8c6e5fd27c14?auto=format&fit=crop&w=800&q=80"
      },
    ...
    <div style={pageWrapper}>
      ...
      <div style={heroSection}>
        <div style={heroContent}>
          <h1 style={heroTitle}>
            My <span style={accentText}>Bookings</span>
          </h1>
      ...
      <div style={statsSection}>
        ...
        <div style={statCard}>
          <div style={statIcon}>💰</div>
          <div style={statNumber}>${bookings.reduce((sum, b) => sum + b.totalAmount, 0).toLocaleString()}</div>
          <div style={statLabel}>Total Spent</div>
        </div>
        <div style={statCard}>
          <div style={statIcon}>✈️</div>
          <div style={statNumber}>{bookings.filter(b => b.status === "pending").length}</div>
      ...
      {loading ? (
        ...
        <div style={emptyState}>
          ...
          <p style={emptyText}>Start exploring trips and book your first adventure!</p>
        </div>
      ) : (
              ...
              <div style={cardContent}>
                ...
                <div style={bookingInfo}>
                  <div style={infoRow}>
                    ...
                    <span style={infoValue}>{formatDate(booking.startDate)} - {formatDate(booking.endDate)}</span>
                  </div>
                  <div style={infoRow}>
                  ...
                  <div style={infoRow}>
                    ...
                    <span style={infoValue}>{booking.bookingReference || "N/A"}</span>
                  </div>
                  <div style={infoRow}>
